  ...
  return (
    <>
      ...
      <div style={{
        ...
        padding: '28px 32px', zIndex: 1200, minWidth: 320, maxWidth: '92vw', maxHeight: '90vh', overflowY: 'auto',
      }}>{children}</div>
    </>
  )
}
    ...
    <div>
      <div onClick={() => ref.current.click()}
        ...
        style={{
          ...
          justifyContent: 'center', minHeight: height, position: 'relative', overflow: 'hidden', transition: 'all .15s',
        }}>
        {uploading && (
        ...
        {value
          ? <img src={value} alt="preview" style={{ width: '100%', height, objectFit: 'cover', display: 'block' }} />
